          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            ...
            {user ? (
                ...
                <div className="flex items-center space-x-4">
                  {profile?.role === 'host' && (
                    <Link
                      to="/dashboard"
                      className={`px-3 py-2 rounded-md text-sm font-medium ${
                        isActive('/dashboard') ? 'text-[#00D1FF]' : 'text-gray-700 hover:text-[#00D1FF]'
                      }`}
                    >
                      Dashboard
                    </Link>
                  ...
                  <button
                    ...
                    className="px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-[#00D1FF]"
                  >
                    Sign Out
                  </button>
                </div>
              ...
              <div className="flex items-center space-x-4">
                <Link
                  to="/login"
                  className="px-3 py-2 border border-transparent text-sm font-medium rounded-md text-[#00D1FF] hover:text-[#00D1FF]/80"
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="px-3 py-2 rounded-md text-sm font-medium text-white bg-[#00D1FF] hover:bg-[#00D1FF]/90 transition-colors"
                >
                  Sign Up
                </Link>
              </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            {user ? (
              <>
                {profile?.role === 'host' && (
                  <Link
                    to="/dashboard"
                    className={`block px-3 py-2 rounded-md text-base font-medium ${
                      isActive('/dashboard') ? 'text-[#00D1FF] bg-gray-50' : 'text-gray-700 hover:text-[#00D1FF] hover:bg-gray-50'
                    }`}
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Dashboard
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#00D1FF] hover:bg-gray-50"
                >
                  Sign Out
                </button>
              </>
              ...
              <>
                <Link
                  to="/login"
                  className="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-[#00D1FF] hover:bg-gray-50"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Login
                </Link>
                <Link
                  to="/register"
                  className="block px-3 py-2 rounded-md text-base font-medium text-white bg-[#00D1FF] hover:bg-[#00D1FF]/90"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Sign Up
                </Link>
